...
@section('content')
    <div class="max-w-5xl mx-auto p-6 space-y-8">
        ...
        <div class="flex justify-between items-center">
            ...
            <a href="{{ route('client.reservations') }}" class="text-sm text-amber-600 hover:underline">
                ← Retour
            </a>
        </div>
        ...
        <div class="flex gap-3">
            ...
            <span
                class="px-3 py-1 text-xs rounded-full
            {{ optional($reservation->payment)->status === 'paid' ? 'bg-blue-100 text-blue-700' : 'bg-red-100 text-red-700' }}">
        ...
        <div class="bg-white rounded-2xl border border-amber-100 shadow-sm overflow-hidden">
            ...
            @if ($reservation->room && $reservation->room->image)
                <img src="{{ asset('storage/' . $reservation->room->image) }}" class="w-full h-64 object-cover">
            @endif
            ...
            <div class="p-6 space-y-6">
                ...
                <div class="grid md:grid-cols-3 gap-6">
                    ...
                    <div class="bg-amber-50 rounded-xl p-4">
                        ...
                        <p class="font-medium text-slate-800">
                            {{ floor(\Carbon\Carbon::parse($reservation->check_in)->diffInDays($reservation->check_out)) }}
                            jours
                        </p>
                    </div>
