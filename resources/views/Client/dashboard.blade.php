          ...
          <tr>
            ...
            <td class="py-2.5">
              @if($reservation->status === 'confirmed')
                <span class="px-2 py-0.5 rounded-full text-xs bg-green-50 text-green-700">Confirmée</span>
            ...
            <td class="py-2.5">
              @if($reservation->payment && $reservation->payment->status === 'paid')
                <span class="px-2 py-0.5 rounded-full text-xs bg-green-50 text-green-700">Payé</span>
              @else
                <span class="px-2 py-0.5 rounded-full text-xs bg-red-50 text-red-700">Non payé</span>
              @endif
            </td>
