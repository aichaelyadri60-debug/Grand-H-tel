        ...
        <div class="flex items-center justify-between">
            ...
            <a class="flex items-center gap-3 group cursor-pointer">
                ...
                <div>
                    ...
                    <p id="logoSub"
                        class="text-xs text-white/70 transition-colors duration-300 tracking-wide">
                        Luxury &amp; Elegance
                    </p>
                </div>
            </a>
            ...
            <div class="hidden lg:flex items-center gap-8">
                <a  href="{{route('homepage')}}" class="nav-link relative text-sm font-medium text-white/90 hover:text-amber-300 transition-colors duration-200 cursor-pointer
                ...
                <a href="{{route('Room.index')}}" class="nav-link relative text-sm font-medium text-white/90 hover:text-amber-300 transition-colors duration-200 cursor-pointer
                           after:absolute after:-bottom-0.5 after:left-0 after:w-0 after:h-px after:bg-amber-400 after:transition-all after:duration-300 hover:after:w-full">
                    Rooms
                </a>
                ...
                <a  href="{{route('contact.index')}}" class="nav-link relative text-sm font-medium text-white/90 hover:text-amber-300 transition-colors duration-200 cursor-pointer
                           after:absolute after:-bottom-0.5 after:left-0 after:w-0 after:h-px after:bg-amber-400 after:transition-all after:duration-300 hover:after:w-full">
                    Contact
                </a>
            </div>
    ...
    <div id="mobileMenu"
        ...
        <div class="px-6 py-5 space-y-1">
            <a class="flex items-center gap-2 px-3 py-2.5 rounded-xl text-slate-600 text-sm font-medium hover:bg-amber-50 hover:text-amber-600 transition-colors duration-200 cursor-pointer">
                <svg class="w-4 h-4 text-amber-400" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path d="M3 9l9-7 9 7v11a2 2 0 01-2 2H5a2 2 0 01-2-2z"/></svg>
                Home
            </a>
            <a class="flex items-center gap-2 px-3 py-2.5 rounded-xl text-slate-600 text-sm font-medium hover:bg-amber-50 hover:text-amber-600 transition-colors duration-200 cursor-pointer">
            ...
            <a class="flex items-center gap-2 px-3 py-2.5 rounded-xl text-slate-600 text-sm font-medium hover:bg-amber-50 hover:text-amber-600 transition-colors duration-200 cursor-pointer">
                <svg class="w-4 h-4 text-amber-400" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><circle cx="12" cy="8" r="4"/><path d="M4 20c0-4 3.58-7 8-7s8 3 8 7"/></svg>
                About Us
            </a>
            <a class="flex items-center gap-2 px-3 py-2.5 rounded-xl text-slate-600 text-sm font-medium hover:bg-amber-50 hover:text-amber-600 transition-colors duration-200 cursor-pointer">
                <svg class="w-4 h-4 text-amber-400" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path d="M22 16.92V19a2 2 0 01-2.18 2A19.79 19.79 0 013 4.18 2 2 0 015 2h2.09a2 2 0 012 1.72c.12.96.36 1.9.7 2.81a2 2 0 01-.45 2.11L8.09 9.91a16 16 0 006 6l1.27-1.27a2 2 0 012.11-.45c.91.34 1.85.58 2.81.7A2 2 0 0122 16.92z"/></svg>
                Contact
            </a>
            ...
            {{-- Staff Login --}}
            <a class="flex items-center justify-center gap-2 w-full py-2.5 px-4 rounded-xl bg-gradient-to-r from-amber-500 to-amber-400 text-white text-sm font-semibold shadow-md shadow-amber-200 hover:from-amber-600 hover:to-amber-500 transition-all duration-200 cursor-pointer">
